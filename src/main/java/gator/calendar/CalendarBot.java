...
public class CalendarBot {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = CalendarBot.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    public static void buildCalendar(String... args) throws IOException, GeneralSecurityException {
    ...
    public static void listEvents() throws IOException, GeneralSecurityException{
        ...
        System.out.println("Calendar Test Function: 10 Closest Events");
        if (items.isEmpty()) {
